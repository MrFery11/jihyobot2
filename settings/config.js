module.exports = {
  TOKEN:
    process.env.TOKEN ||
    "OTMxMjM5MTkzNTQ2NDU3MDk5.GhPVoy.DwsyHGCz8-P9lQ_elpq9hgLYp2EqfmffDTymKM",
  PREFIX: process.env.PREFIX || "-",
  embed: {
    color: process.env.color || "#FAC857",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Jihyo Bot © | 2022",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  // others
  guildID: process.env.guildID || "858189433340821514", // for slash command
  mongodb : process.env.mongodb || "mongodb+srv://namibot:vg2001crack@cluster0.rgo7q.mongodb.net/test",
  filters: {
